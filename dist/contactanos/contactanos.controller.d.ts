...
export declare class ContactanosController {
    ...
    findAll(): import("mongoose").Query<(import("mongoose").Document<unknown, any, import("./entities/contactano.entity").Contactano> & import("./entities/contactano.entity").Contactano & {
        _id: import("mongoose").Types.ObjectId;
    })[], import("mongoose").Document<unknown, any, import("./entities/contactano.entity").Contactano> & import("./entities/contactano.entity").Contactano & {
        _id: import("mongoose").Types.ObjectId;
    }, {}, import("./entities/contactano.entity").Contactano>;
}
